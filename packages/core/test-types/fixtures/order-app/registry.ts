...
export const registry = {
  aggregates: {
    ...
    order: {
      ...
      commands: {
        placeOrder: { module: placeOrder, collaborators: { inventory: { fake: inventoryFake } } },
  ...
  readModels: {
    orderSummary: {
      ...
      projections: { orderPlaced: orderSummaryOnOrderPlaced, orderPaid: orderSummaryOnOrderPaid },
      queries: { getOrder, listUnpaidOrders, customerOverview },
    },
  },
